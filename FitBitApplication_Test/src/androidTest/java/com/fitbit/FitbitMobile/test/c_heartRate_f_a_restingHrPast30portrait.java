...
public class c_heartRate_f_a_restingHrPast30portrait extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public c_heartRate_f_a_restingHrPast30portrait() throws ClassNotFoundException {
	...
	public void testRun() {
        ...
        //sleep - shot
        solo.sleep(500);
        //solo.takeScreenshot("d_restingHRpast30expandedPort_a_dash");
        //Click on -- bpm 64 bpm resting
		solo.clickInList(3, 0);
        solo.takeScreenshot("d_restingHRpast30expandedPort_b_tapTile");
        ...
        //sleep - shot
        solo.sleep(500);
        //solo.takeScreenshot("d_restingHRpast30expandedPort_c_heartRate");
        ...
        //sleep - shot
        solo.sleep(500);
        //solo.takeScreenshot("d_restingHRpast30expandedPort_d_expand");
