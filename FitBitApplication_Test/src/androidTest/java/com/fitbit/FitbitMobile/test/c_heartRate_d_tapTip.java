...
public class c_heartRate_d_tapTip extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public c_heartRate_d_tapTip() throws ClassNotFoundException {
	...
	public void testRun() {
		...
		solo.clickOnText(java.util.regex.Pattern.quote("Resting heart rate measures your heart beats when you are still. Wear during sleep for more accuracy. Learn more…"));
        //sleep - shot
        solo.sleep(500);
