...
public class c_heartRate_i_f_switchLandscape extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public c_heartRate_i_f_switchLandscape() throws ClassNotFoundException {
